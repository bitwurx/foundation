...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'events_event', 'description', self.gf('django.db.models.fields.CharField')(max_length=400, null=True))

    def backwards(self, orm):

        # Changing field 'Event.description'
        db.alter_column(u'events_event', 'description', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))
    ...
    models = {
        ...
        u'events.event': {
            ...
            'calendar': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
