...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'companies_companyprofile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('sic_code', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True)),
        ))
        db.send_create_signal(u'companies', ['CompanyProfile'])

        # Adding model 'Tag'
        db.create_table(u'companies_tag', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal(u'companies', ['Tag'])
        ...
        db.create_table(u'companies_company', (
            ...
            ('city', self.gf('django.db.models.fields.CharField')(max_length=25, null=True)),
            ...
            ('sales_volume', self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True)),
            ('profile', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['companies.CompanyProfile'], null=True, blank=True)),
            ...
            ('contact', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('location', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('best_time_to_call', self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True)),
            ...
            ('tags', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['companies.Tag'], null=True, blank=True)),
            ('infoconnect_url', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ))
        db.send_create_signal(u'companies', ['Company'])

        # Adding model 'ListField'
        db.create_table(u'companies_listfield', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'companies', ['ListField'])


    def backwards(self, orm):
        # Deleting model 'CompanyProfile'
        db.delete_table(u'companies_companyprofile')

        # Deleting model 'Tag'
        db.delete_table(u'companies_tag')

        # Deleting model 'Company'
        db.delete_table(u'companies_company')

        # Deleting model 'ListField'
        db.delete_table(u'companies_listfield')
