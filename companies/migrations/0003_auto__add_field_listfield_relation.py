...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ListField.relation'
        db.add_column(u'companies_listfield', 'relation',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ListField.relation'
        db.delete_column(u'companies_listfield', 'relation')
