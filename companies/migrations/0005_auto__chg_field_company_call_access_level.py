...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Company.call_access_level'
        db.alter_column(u'companies_company', 'call_access_level', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Company.call_access_level'
        db.alter_column(u'companies_company', 'call_access_level', self.gf('django.db.models.fields.IntegerField')())
