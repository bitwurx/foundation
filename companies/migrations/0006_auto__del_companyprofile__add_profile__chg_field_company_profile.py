...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'companies_profile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('sic_code', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True)),
        ))
        db.send_create_signal(u'companies', ['Profile'])


        # Changing field 'Company.profile'
        db.alter_column(u'companies_company', 'profile_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['companies.Profile'], null=True))
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'companies_profile')


        # Changing field 'Company.profile'
        db.alter_column(u'companies_company', 'profile_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['companies.CompanyProfile'], null=True))
