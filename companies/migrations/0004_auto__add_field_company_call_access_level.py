...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Company.call_access_level'
        db.add_column(u'companies_company', 'call_access_level',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Company.call_access_level'
        db.delete_column(u'companies_company', 'call_access_level')
    ...
    models = {
        ...
        u'companies.company': {
            ...
            'call_access_level': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
