...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'notes_note', 'text', self.gf('django.db.models.fields.CharField')(max_length=1000))

    def backwards(self, orm):

        # Changing field 'Note.text'
        db.alter_column(u'notes_note', 'text', self.gf('django.db.models.fields.CharField')(max_length=255))
